...
df_ad = pd.read_csv('../data/promoted_content.csv', usecols  = ('ad_id','document_id'),
                    dtype={'ad_id': np.int, 'uuid': np.str, 'document_id': np.str})
df_events = pd.read_csv('../data/events.csv', usecols  = ('display_id','uuid','timestamp'),
...
del subm['prob']
subm.to_csv("../output/subm_leak.csv")
